    ...
    _.extend(Youtube.prototype, {
        ...
        getDomValue: function(selector, attr, callback){
            ...
            var doneCallback = function(event) {
                ...
                if(event.url.indexOf(urlEvent) > 0 && !done) {
                    done = true;
                    callback(
                        decodeURIComponent(
            ...
            var code = '(function(){'+
                            'var interval = setInterval(function(){'+
                                ...
                                'if(!element){return}else{clearInterval(interval)}console.log("test '+attr+'");';
            ...
            code +=         'setTimeout(function(){window.location.href = "#' + urlEvent + '/"+value;}, 500);'+
                        '}, 400);' +
                    '})();';
